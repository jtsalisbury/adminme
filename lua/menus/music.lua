...
hook.Add("AddAdditionalMenuSections", "am.addMusicMenu", function(stor)
	local function populateList(scroller, main, frame)
		...
		nameLbl:SetText("")
		nameLbl:SetFont("adminme_header")
		...
		lenLbl:SetText("")
		lenLbl:SetFont("adminme_header")
		function lenLbl:Paint(w, h)
			draw.RoundedBox(8, 0, 0, w, h, cols.head_panel_head_bg)
			draw.SimpleText("Length", "adminme_header", w / 2, h / 2, cols.head_panel_text, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		end

		local hider1 = vgui.Create("DPanel", idLbl)
		hider1:SetSize(15, 15)
		hider1:SetPos(0, 35)
