am.addCMD("adduser", "Adds a player to a rank", "User Mgmt", function(caller, target, rank, server)
	...
	q:execute()	
end):addParam("target", "player"):addParam("rank", "string"):addParam("Server(s)", "string"):setPerm("usermgmt")
...
end):addParam("target", "player"):addParam("rank", "string"):addParam("Server(s)", "string"):addParam("time", "number"):addParam("time type", "time_type"):setPerm("usermgmt")
